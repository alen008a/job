...
type ExecutorParams struct {
	...
	PullType    mdata.PullType    `json:"pullType"`
	StartTime   string            `json:"startTime"` //设置更新起始时间
	EndTime     string            `json:"endTime"`   //设置更新结束时间,为空则不限制结束
	PullReqType mdata.PullReqType `json:"pullReqType"`
}
